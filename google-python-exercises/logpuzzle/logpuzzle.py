...
def url_sort_key(url):
  """Used to sort urls in increasing order by 2nd word if present."""
...
def read_urls(filename):
  ...
  Screens out duplicate urls and returns the urls sorted increasing order."""
  # +++your code here+++
  # log file animal_code.google.com is from the 'code.google.com' server
  # server name is whatever follows the first underbar
  ...
  for line in f:
    ...
    # uses \S for any non-space char
    # Alternately could use square brackets: "GET ([^ ]+)" or "GET (.+?) "
...
# find all urls from log file
# ./logpuzzle.py animal_code.google.com

# retrieve all imgs to file animaldir
# ./logpuzzle.py --todir animaldir animal_code.google.com
# ls animaldir

# When it's all working, opening the
# index.html file should reveal the original animal image.
